...
import com.hititcs.dcs.view.baggagetracking.domain.model.TrackBaggageLocationCodeDto;
import java.util.List;

public class BagAreaCodeAdapter extends ArrayAdapter<TrackBaggageLocationCodeDto> {

  private int selectedItemPosition = -1;
  private Typeface extraLight;
  private Typeface bold;

  BagAreaCodeAdapter(@NonNull Context context, int resource,
      @NonNull List<TrackBaggageLocationCodeDto> objects) {
